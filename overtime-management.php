<?php
	...
	$api = new Api;
	$page_title = 'Manage Overtime Application';

	# Check role permission
	$page_access = $api->check_role_permissions($username, 404);
	$add_overtime = $api->check_role_permissions($username, 406);
                                ...
                                <div class="card">
                                    <div class="card-body">
                                            ...
                                            <div class="col-md-6">
                                                <div class="float-end btn-group">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-end">
                                                        <?php
                                                            if($add_overtime > 0){
                                                                echo '<a class="dropdown-item" href="javascript: void(0);" id="add-training">Add Overtime Application</a>';
                                                            }
                                                        ?>
                                        ...
                                        <div class="row">
                                                    ...
                                                    <div class="d-flex gap-2">
                                                                <div class="float-end btn-group">
                                                                    ...
                                                                    <div class="dropdown-menu dropdown-menu-end">
                                                                        <?php
                                                                            if($add_overtime > 0){
                                                                                echo '<a class="dropdown-item" href="javascript: void(0);" id="add-overtime">Add Overtime Application</a>';
                                                                            }
                                                                        ?>
                                           ...
                                           <div class="row mt-4">
                                            <div class="col-md-12">
                                                <table id="overtime-datatable" class="table table-bordered align-middle mb-0 table-hover table-striped dt-responsive nowrap w-100">
                                                    <thead>
                                                        <tr>
